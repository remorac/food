...
class ScheduleMenu extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['schedule_id', 'menu_id'], 'required'],
            [['schedule_id', 'menu_id', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
    ...
    {
        return $this->hasMany(Reservation::className(), ['schedule_menu_id' => 'id']);
    }
    ...
    {
        return $this->menu->name. ' ('.$this->menu->supplier->name.')';
    }
}
